...
export class PaymentRequestService {
  async createPaymentRequest(requestData: Partial<PaymentRequest>): Promise<PaymentRequest> {
    try {
      ...
      const newRequest = {
        ...
        related_offer_id: requestData.relatedOfferId || null,
        related_application_id: requestData.relatedApplicationId || null,
  ...
  private transformFromDatabase(dbData: any): PaymentRequest {
    return {
      ...
      relatedOfferId: dbData.related_offer_id,
      relatedApplicationId: dbData.related_application_id,
