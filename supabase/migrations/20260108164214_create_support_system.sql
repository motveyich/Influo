/*
  ...
  1. New Tables
    - `support_tickets`
      ...
      - `category` (text) - Категория: general, technical, billing, account, feature, bug
      - `priority` (text) - Приоритет: low, normal, high, urgent
      - `status` (text) - Статус: open, in_progress, resolved, closed
      - `created_at` (timestamptz)
      - `updated_at` (timestamptz)
      - `assigned_to` (uuid, references auth.users) - Назначено на админа/модератора
      - `resolved_at` (timestamptz) - Дата решения
    ...
    - `support_messages`
      ...
      - `message` (text)
      - `is_staff_response` (boolean) - Ответ от поддержки
      - `created_at` (timestamptz)
...
-- Staff can create messages in any ticket
